...
export default async function CustomerArtworkResubmissionPage({
  ...
  return (
    <div className="mx-auto max-w-3xl">
      <Link
        className="inline-flex min-h-11 items-center rounded-xl text-sm font-bold text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
      ...
      {data.correctionNote ? (
        <section className="mt-7 rounded-2xl border border-amber-200 bg-amber-50 p-5">
          ...
          {data.correctionReferenceUrl ? (
            <a
              className="mt-4 inline-flex min-h-11 items-center font-bold text-amber-950 underline underline-offset-4"
